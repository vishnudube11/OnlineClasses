...
import { View, Text, StyleSheet, Pressable, ActivityIndicator, useWindowDimensions, Animated } from 'react-native';
    ...
    >
      ...
      <Animated.View style={[
        ...
        <View style={styles.logoArea}>
          ...
          <Text style={styles.tagline}>Your gateway to unlimited knowledge.</Text>
        </View>
